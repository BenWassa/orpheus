...
- [ ] P1: Rewrite academic labels into natural report language without hiding the underlying data.
...
- [ ] Commit terminology and copy cleanup after the UI reads clearly end to end.
